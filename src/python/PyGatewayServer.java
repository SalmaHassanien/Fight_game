...
/**
 * A class that manages the gateway for performing Java processing using Python.
...
public class PyGatewayServer {
	...
	/**
         * A class constructor that creates a gateway using the game scene passed as an argument.
